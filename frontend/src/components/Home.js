...
const Home = () => {
    ...
    <div className="flex flex-col min-h-screen">
      <header className="flex items-center justify-between px-6 py-4 bg-white">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold">JIET HOSPITAL</span>
        </div>
  ...
  <img src="home-1.jpeg" alt="Hospital" className="w-full h-full object-cover" />
</section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 text-left">
                Our hospital  provides cutting-edge features to streamline your workflows, improve
        ...
        <Section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: DollarSign, title: "Cost Savings", description: "Our Jiet hospital  helps you optimize operations and reduce overhead costs, leading to significant cost savings." },
      ...
      <footer className="bg-white py-6 border-t">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <p className="text-gray-600">&copy; 2025 Jiet Management. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
